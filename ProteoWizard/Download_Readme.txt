...
Alternatively, to download a .tar.bz2 file with the latest .Exe files.  
	Direct link:
		http://teamcity.labkey.org:8080/viewType.html?buildTypeId=bt36&tab=buildTypeStatusDiv
	Or use these steps:
...
After downloading the .tar.bz2 file, extract the data using 7-zip (http://www.7-zip.org/) or WinRar
